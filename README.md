...
- **タップ／連打＝飛散**: 16個の質点が3D方向へ爆ぜる。**興奮するほど `smin` の融合を弱めて飛沫にバラけ**、落ち着くと再合体して中心へ戻る（連打すると塊が割れて散る）
...
- マテリアルは液体クローム（鋭いスペキュラ＋スタジオ照明の擬似環境反射＋フレネル＋反射の色収差/分散）。背景はほぼ黒＋強ビネットで被写体を締める。疑似ブルームでシルエットがにじむ。仕上げにS字コントラスト＋黒締め＋グレイン
